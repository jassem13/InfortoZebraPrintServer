        ...
        <c:forEach items="${connectedPrinters}" var="printer" varStatus="count">
            <tr class="${count.index % 2 == 0 ? '' : 'alt'}">
                ...
                <td>
                    ...
                    &nbsp;---&nbsp;
  					<a id="FileSend-${printer.serialNumber}" href="#">Send File</a>
                    <script type="text/javascript">
                        $("#FileSend-${printer.serialNumber}").click(function (event) {
                            event.preventDefault();
                            $.post('/ZebraWebServicesDeveloperDemo/FileSend?serialNumber=${printer.serialNumber}');
                        });
                    </script>
